...
private extension SquirrelInputController {
  ...
  func commit(string: String) {
    ...
    // === Personal Log AI IPC Hook ===
    // 将提交的文本通过 IPC 发送给 Personal Log AI 主应用
    let appBundleId = client.bundleIdentifier() as String?
    let appName = NSWorkspace.shared.frontmostApplication?.localizedName
    LogIPCClient.shared.sendCommittedText(string, appBundleId: appBundleId, appName: appName)
  }
